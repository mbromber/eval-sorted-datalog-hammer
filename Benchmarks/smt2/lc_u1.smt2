...
(SpeedFront 0 0 5 1 achangeright) 
(LaneNotSafe 0 0 achangeright) 
(DistanceBehind 0 1 (- 11) 5 amovestraight) 
(SpeedBehind 0 1 (- 11) 2 amovestraight) 
(DistanceFront 0 1 12 5 amovestraight) 
(SpeedFront 0 1 12 2 amovestraight) 
(LaneSafe 0 1 amovestraight) 
(DistanceBehind 0 2 4 0 achangeleft) 
(SpeedBehind 0 2 4 5 achangeleft) 
(LaneNotSafe 0 2 achangeleft) 
(DistanceBehind 0 1 (- 11) 5 adeceleratestraight) 
(SpeedBehind 0 1 (- 11) 2 adeceleratestraight) 
(DistanceFront 0 1 12 5 adeceleratestraight) 
(SpeedFront 0 1 12 2 adeceleratestraight) 
(LaneSafe 0 1 adeceleratestraight) 
(DistanceBehind 0 1 (- 11) 5 aacceleratestraight) 
(SpeedBehind 0 1 (- 11) 2 aacceleratestraight) 
(DistanceFront 0 1 12 5 aacceleratestraight) 
(SpeedFront 0 1 12 2 aacceleratestraight) 
(LaneSafe 0 1 aacceleratestraight) 
(DistanceFront 0 0 5 0 aaccelerateright) 
(SpeedFront 0 0 5 1 aaccelerateright) 
(LaneNotSafe 0 0 aaccelerateright) 
(DistanceFront 0 0 5 0 adecelerateright) 
(SpeedFront 0 0 5 1 adecelerateright) 
(LaneNotSafe 0 0 adecelerateright) 
(DistanceBehind 0 2 4 0 adecelerateleft) 
(SpeedBehind 0 2 4 5 adecelerateleft) 
(LaneNotSafe 0 2 adecelerateleft) 
(EgoCar 0 1 5 3) 
(SuggestedAction 0 amovestraight) 
(SuggestedAction 0 adeceleratestraight) 
(SuggestedAction 0 aacceleratestraight) 
(DistanceBehind 1 2 (- 11) 5 achangeleft) 
(SpeedBehind 1 2 (- 11) 5 achangeleft) 
(DistanceFront 1 2 12 5 achangeleft) 
(SpeedFront 1 2 12 5 achangeleft) 
(LaneSafe 1 2 achangeleft) 
(DistanceBehind 1 1 (- 11) 5 amovestraight) 
(SpeedBehind 1 1 (- 11) 2 amovestraight) 
(DistanceFront 1 1 7 1 amovestraight) 
(SpeedFront 1 1 7 2 amovestraight) 
(LaneNotSafe 1 1 amovestraight) 
(DistanceFront 1 0 5 0 achangeright) 
(SpeedFront 1 0 5 1 achangeright) 
(LaneNotSafe 1 0 achangeright) 
(DistanceBehind 1 1 (- 11) 5 adeceleratestraight) 
(SpeedBehind 1 1 (- 11) 2 adeceleratestraight) 
(DistanceFront 1 1 7 1 adeceleratestraight) 
(SpeedFront 1 1 7 2 adeceleratestraight) 
(LaneSafe 1 1 adeceleratestraight) 
(DistanceBehind 1 1 (- 11) 5 aacceleratestraight) 
(SpeedBehind 1 1 (- 11) 2 aacceleratestraight) 
(DistanceFront 1 1 7 1 aacceleratestraight) 
(SpeedFront 1 1 7 2 aacceleratestraight) 
(LaneNotSafe 1 1 aacceleratestraight) 
(DistanceBehind 1 2 (- 11) 5 aaccelerateleft) 
(SpeedBehind 1 2 (- 11) 5 aaccelerateleft) 
(DistanceFront 1 2 12 5 aaccelerateleft) 
(SpeedFront 1 2 12 5 aaccelerateleft) 
(LaneSafe 1 2 aaccelerateleft) 
(DistanceFront 1 0 5 0 aaccelerateright) 
(SpeedFront 1 0 5 1 aaccelerateright) 
(LaneNotSafe 1 0 aaccelerateright) 
(DistanceFront 1 0 5 0 adecelerateright) 
(SpeedFront 1 0 5 1 adecelerateright) 
(LaneNotSafe 1 0 adecelerateright) 
(DistanceBehind 1 2 (- 11) 5 adecelerateleft) 
(SpeedBehind 1 2 (- 11) 5 adecelerateleft) 
(DistanceFront 1 2 12 5 adecelerateleft) 
(SpeedFront 1 2 12 5 adecelerateleft) 
(LaneSafe 1 2 adecelerateleft) 
(EgoCar 1 1 5 3) 
(SuggestedAction 1 achangeleft) 
(SuggestedAction 1 adeceleratestraight) 
