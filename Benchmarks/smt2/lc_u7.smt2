...
(declare-fun ResultDeg (Real Real Real Real Real Fol ) Bool)
...
(forall ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Fol) )(=> (SafeActionDoesNotMatchChangeToLane x0 x1 x2 x3 x4 x5) (ResultDeg x0 x1 x2 x3 x4 x5) ))
(forall ((x0 Int) (x1 Int) (x2 Int) (x3 Int) (x4 Int) (x5 Fol) )(=> (ActionMatchesChangeToLane x0 x1 x2 x3 x4 x5) (ResultDeg x0 x1 x2 x3 x4 x5) ))
...
(=> (> 0 GC4) false)
(=> (> GC4 5) false)
(=> (ResultDeg GC0 GC1 GC2 GC3 GC4 GC5) false)
))
